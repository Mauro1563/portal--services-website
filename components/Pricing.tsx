      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-slate-400">
            Pay monthly. Cancel anytime. 14-day free trial — no credit card required.
          </p>
        </div>
        ...
        <div className="mt-16 grid gap-5 lg:grid-cols-3">
          {tiers.map((t) => (
            <Card
              ...
              className={
                t.featured
                  ? 'relative flex flex-col p-8 ring-1 ring-cyan-400/30 shadow-[0_0_60px_-15px_rgba(6,182,212,0.4)]'
                  : 'relative flex flex-col p-8'
              }
            >
              {t.featured && (
                <Badge tone="info" className="absolute -top-3 right-6">
                  Most popular
                </Badge>
              )}
        ...
        <p className="mt-10 text-center text-xs text-slate-500">
          All prices in GBP. Volume discounts for 100+ operatives. VAT not included.
        </p>
      </div>
    </section>
  );

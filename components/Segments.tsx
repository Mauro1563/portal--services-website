      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="font-display text-4xl font-semibold tracking-tight">
            From 5 cleaners to 5,000 operatives.
          </h2>
          <p className="mt-4 text-slate-400">
            Three tiers — same platform. Start small, scale to enterprise without changing tools.
          </p>
        </div>
          ...
          {segments.map((seg) => {
            ...
            return (
              <Card
                ...
                className={
                  seg.featured
                    ? 'relative flex flex-col p-7 ring-1 ring-cyan-400/30 shadow-[0_0_60px_-15px_rgba(6,182,212,0.4)]'
                    : 'relative flex flex-col p-7'
                }
              >
                <Badge tone={seg.tone} className="absolute -top-3 right-6">
                  {seg.badge}
                </Badge>
                ...
                <p className="mt-5 font-display text-2xl font-semibold text-cyan-300">
                  {seg.pricing}
                </p>
                ...
                <p className="mt-6 text-xs leading-relaxed text-slate-500">
                  <span className="font-semibold text-slate-400">Typical customers:</span>{' '}
                  {seg.customers}
                </p>

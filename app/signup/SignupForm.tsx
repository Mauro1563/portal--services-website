  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50/60">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-6xl items-center justify-center px-4 py-10">
        <div className="grid w-full overflow-hidden rounded-[2rem] bg-white shadow-[0_30px_80px_-30px_rgba(15,23,42,0.35),0_8px_24px_-12px_rgba(15,23,42,0.15)] ring-1 ring-slate-200/70 lg:grid-cols-[1.05fr_1.1fr]">
          {/* ===== Brand panel (desktop) ===== */}
          <aside className="relative hidden overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950 to-blue-900 p-10 text-white lg:flex lg:flex-col lg:justify-between">
            ...
            <div className="relative">
              <div className="inline-flex items-center rounded-2xl bg-white/95 px-4 py-2.5 shadow-lg shadow-blue-900/30 ring-1 ring-white/40">
                <Logo size="sm" />
              </div>
              ...
              <p className="mt-4 max-w-sm text-[15px] leading-relaxed text-slate-300">
                Sin llamadas, sin emails de ida y vuelta. Rellenas el
                formulario y entras directo a tu portal con todo configurado.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  body: 'El sistema crea tu cuenta y te muestra los datos al instante.',
                },
                {
                  icon: ShieldCheck,
                  title: 'Tu equipo en minutos',
                  body: 'Invita limpiadoras con PIN y configura tus propiedades.',
                },
                {
                  icon: CheckCircle2,
                  title: 'Sin tarjeta de crédito',
                  body: 'Prueba todo gratis. Decides después si te sirve.',
                },
          ...
          {/* ===== Form / Success panel ===== */}
          <section className="relative flex flex-col px-6 py-10 sm:px-12 sm:py-12">

...
export function SubmitButton({ label, pendingLabel }: Props) {
  ...
  return (
    <button
      ...
      disabled={pending}
      aria-busy={pending}
      className="group relative inline-flex h-12 w-full items-center justify-center gap-2 overflow-hidden rounded-xl bg-[#0A0D18] text-[13px] font-bold uppercase tracking-[0.20em] text-white shadow-[0_14px_28px_-10px_rgba(0,216,199,0.45),inset_0_1px_0_rgba(255,255,255,0.20)] ring-1 ring-[#10B981]/40 transition hover:brightness-[1.08] hover:ring-[#10B981] active:translate-y-px disabled:cursor-not-allowed disabled:opacity-80 disabled:hover:brightness-100"
    >

  ...
  return (
    <div className="relative w-full min-w-0">
      ...
      <input
        ...
        placeholder="••••••••"
        className="block h-12 w-full min-w-0 rounded-xl border border-slate-200 bg-white pl-10 pr-11 text-sm font-medium text-slate-900 placeholder:font-normal placeholder:text-slate-400 transition focus:border-[#10B981] focus:outline-none focus:ring-4 focus:ring-[#10B981]/20"
      />
      <button
        type="button"
        onClick={() => setShow((s) => !s)}
